...
/**
 * EJB que exposa el servei Spring {@link EntitatResourceService} al WAR del backoffice (mode JBoss).
 *
 * @author Límit Tecnologies
 */
@Local(EntitatResourceService.class)
@Stateless
@RolesAllowed("**")
public class EntitatResourceServiceEjb extends AbstractServiceEjb<EntitatResourceService> implements EntitatResourceService {
	...
	@Delegate
	private EntitatResourceService delegateService;
