...
import es.caib.concsv.logic.intf.enums.EniSignatureType;
...
import es.caib.concsv.logic.util.MyDocumentConverter;
...
public class HashServiceTest {
	...
	public static void setUp() throws Exception {
		...
		byte[] contingut;
		try (InputStream inputStream = HashServiceTest.class.getClassLoader().getResourceAsStream(arxiu + "." + extensio)) {
			contingut = inputStream.readAllBytes();
		}
