package es.caib.concsv.commons.rest;
...
public interface RestConstants {
     ...
     */
    String REQUEST_LOCALE = "es.caib.concsv.commons.rest.requestLocale";

    /**
     * Paràmetre del context definit al web.xml amb la llista de locales soportats.
     */
    String SUPPORTED_LOCALES = "es.caib.concsv.commons.rest.supportedLocales";
}
