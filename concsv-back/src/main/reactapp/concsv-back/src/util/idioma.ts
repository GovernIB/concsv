...
/**
 * El perfil desa l'idioma com el nom de la constant d'IdiomaEnum ("CA"/"ES") i pot arribar
 ...
 * del perfil de l'usuari (csv_usuari.idioma) i, si no en té, el que detecta i18next.
 *
 * Tant ConcsvProvider (que l'aplica a l'API abans de pintar l'aplicació) com BaseApp (que el
