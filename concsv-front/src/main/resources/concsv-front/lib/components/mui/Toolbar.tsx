...
import { ReactElementWithPosition, joinReactElementsWithReactElementsWithPositions } from '../../util/reactNodePosition';
...
export const Toolbar: React.FC<ToolbarProps> = (props) => {
    ...
    const toolbarElements: React.ReactElement[] = title ? [
        titleElement,
