...
import { FilterContext, FilterApi, FilterApiRef } from './FilterContext';
import { useFormApiRef } from './Form';
import { FormApiRef } from './FormContext';
...
export const Filter: React.FC<FilterProps> = (props) => {
    ...
    if (apiRefProp) {
        if (apiRefProp.current) {
            ...
            console.warn('apiRef prop must be initialized with empty object');
        }
    }
    const context = {
        resourceName,
